...
interface AddProductToPriceListModalProps {
  open: boolean;
  onClose: () => void;
  onAddToList: (pr: PriceListDetailsType) => void;
  productsInList: PriceListDetailsType[];
}
...
const AddProductToPriceListModal: React.FC<AddProductToPriceListModalProps> = ({
  open,
  onClose,
  onAddToList,
  productsInList,
