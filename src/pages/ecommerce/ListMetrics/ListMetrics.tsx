...
import {
  ...
  import { useNavigate } from "react-router";import DataReportsEcommerceSection from "../../../components/report/DataReportsEcommerce";
;
  ...
  const ListMetricsPage: React.FC = () => {
    ...
    useEffect(() => {
      if (permissionsLoaded && !allowReports) {
        ...
        mixtrack("reports_to_ecommerce_redirect", {
